...
#define JCA_IOT_ELEMENT_STATE_IDLE 0
#define JCA_IOT_ELEMENT_STATE_COOL 1
#define JCA_IOT_ELEMENT_STATE_HEAT 2
...
#define JCA_IOT_ELEMENT_TYPE_OR 4
#define JCA_IOT_ELEMENT_TYPE_CLOCKSPAN 5
#define JCA_IOT_ELEMENT_TYPE_CLOCKPULSE 6
#define JCA_IOT_ELEMENT_TYPE_HEATCOOL 7
#define JCA_IOT_ELEMENT_TYPE_DS18B20 8
#define JCA_IOT_ELEMENT_TYPE_AV 9
#define JCA_IOT_ELEMENT_TYPE_PWM 10
